...
module.exports = function Client(options) {
    ...
    this.__initInstance = function (options) {
        ...
        // Workspace
        this.initWorkspace(this.options.workspace);
        ...
        (function (_this) {
            _this.begin(function () {
                ...
                var backup = new BackupJob({
                    ...
                    src: _this.target,
                    target: _this.workspace.getRoot() + '/backup/' + _this.getJobDatetime()
                });

                backup.do({
                    success: function () {

                        var deploy = new DeployJob({
                            client: _this,
                            workspace: _this.workspace
                        });
